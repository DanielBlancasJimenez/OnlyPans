            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('recipes.store') }}" method="POST">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="ingredientes" class="block mt-1 w-full" name="ingredientes" required>{{ old('ingredientes') }}</textarea>
                    </div>

                    <div class="mt-4">
                        <x-label for="instrucciones" :value="__('Instrucciones')" />
                        <textarea id="instrucciones" class="block mt-1 w-full" name="instrucciones" required>{{ old('instrucciones') }}</textarea>
                    </div>
